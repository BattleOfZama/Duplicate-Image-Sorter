...
**Duplicate names**
I had something like 50,000 photos, and many had the same name, despite being diff photos. This script handles those by simply adding a suffix to the name of addiational images with the same name, and copies them over/ They are not lost.

**What image types / file extensions does it support?**
